                            ...
                            <tr id="luni">
                                ...
                                <c:forEach items="${orar}" var="ore" varStatus="contor">
                                    ...
                                    <c:if test="${ore.getZi()=='1.Luni' }">
                                        <td class="${ore.getZi()}" title="${ore.getDurata()},${ore.getSala()},${ore.getSgr()},${ore.getSapt()}">
                                            <a href="javascript:void(0);" onclick="return addNote(${ore.getId()},${sessionScope.userId})" class="ui"> ${ore.getName()}</a>
                                            <a href="javascript:void(0);" onclick="return deleteOra(${ore.getId()})" class="buton">Delete!</a></td>
