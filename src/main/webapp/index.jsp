...
<table class="black" style="margin-top: 5pt; width: 570pt">
    ...
    <tr>
        ...
        <td style="padding-bottom: 15pt">
            ...
            <div style="text-align: center; padding-top: 3pt"><b>
                <b style="color: #A83838">Owner</b> -
                <b style="color: #ff0026">Administrator</b> -
                <b style="color: #5d56ef">Moderator</b> -
                <b style="color: #ffa00b">Guest of Honour</b> -
                <b style="color: #089f00">VIP</b> -
                <b style="color: #b52db5">Sef de Grupa</b> -
                <b>Student</b>
            </b></div>
        </td>
    </tr>
