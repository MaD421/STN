...
public class UserHelper extends DBConnection{
    ...
    public int addUser(String username, String password, byte[] salt, String email, String firstName, String lastName, int idGrupa, int idSerie, int idFacultate, int userClass) throws ClassNotFoundException, SQLException {
        if(idGrupa != 0) {
